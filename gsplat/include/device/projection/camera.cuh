...
struct DeviceOpencvPinholeProjection : OpencvPinholeProjection {
    ...
    //     // GSPLAT_HOST_DEVICE glm::fvec2 get_principal_point() const {return
    //     principal_point;}
    //     // GSPLAT_HOST_DEVICE std::array<float, 6> get_radial_coeffs() const
    //     {return radial_coeffs;}
    //     // GSPLAT_HOST_DEVICE std::array<float, 2> get_tangential_coeffs()
    //     const {return tangential_coeffs;}
    //     // GSPLAT_HOST_DEVICE std::array<float, 4> get_thin_prism_coeffs()
    //     const {return thin_prism_coeffs;}
};
