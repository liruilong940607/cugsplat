...
//         create_device_ptr<fvec3>({fvec3(0.25f, 0.0f, 0.25f), fvec3(0.25f, 0.0f,
//         0.25f)}
//         );
...
//     // Prepare forward outputs
//     auto render_last_index_ptr = create_device_ptr<int32_t>(image_height *
//     image_width); auto render_alpha_ptr =
//         create_device_ptr<float>(image_height * image_width); // only alloc mem, no
//         init
